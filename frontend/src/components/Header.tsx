  ...
  return (
    <div className="flex flex-row items-center justify-between h-28 bg-slate-300 border-b-2 border-b-black">
      ...
      <div className="flex justify-around w-2/5 mr-12 lg:visible sm:invisible">
          <a href="/" className="text-lg font-semibold text-blue-800 transition-all hover:text-red-400">Home</a>
          <a href="/groups" className="text-lg font-semibold text-blue-800 transition-all hover:text-red-400">Groups</a>
          <a href="/create" className="text-lg font-semibold text-blue-800 transition-all hover:text-red-400">Create</a>
      </div>
    </div>
  );
};
